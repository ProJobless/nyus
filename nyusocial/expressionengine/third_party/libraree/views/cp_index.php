...
?>
			...
			<table style="width:100%;float:left;" cellspacing="2" cellpadding="2" border="0" align="center" class="mainTable" id="multee_slugs_tbl">
				...
				<tr>
					...
					<?php
						if($row['site_id']==0)
						{
							$fn = $settings['path'].'/snippets/'.$sitename.'/'.$row['snippet_name'].'.snip';
						}
						else
						{
							$fn = $settings['path'].'snippets/'.$sitename.'/'.$row['snippet_name'].'.snip';
						...
						$file_info = get_file_info($fn, array('name', 'server_path', 'size', 'date', 'fileperms'));
		
						$sync_time 	= $file_info["date"];
		    
						$sync_time_human = (isset($settings["snippets_enabled"])) ? date("Y-m-d H:i:s",$file_info["date"]) : "no file";
		
						echo $sync_time_human;
					?>
					</td>-->
			...
			<table style="width:100%;float:left;" cellspacing="2" cellpadding="2" border="0" align="center" class="mainTable" id="multee_slugs_tbl">
				...
				?>
				<tr>
					<td width="30%"><?php echo $row['variable_name'];?></td>
					<!--<td width="20%">
					<?php
						$fn = $settings['path'].'global_variables/'.$sitename.'/'.$row['variable_name'].'.glob';
						//echo $fn;
						...
						$sync_time_human = (isset($settings["global_variables_enabled"])) ? date("Y-m-d H:i:s",$file_info["date"]) : "no file";
			...
			<table style="width:100%;float:left;" cellspacing="2" cellpadding="2" border="0" align="center" class="mainTable" id="multee_slugs_tbl">
				...
				<tr>
					...
					<!--<td width="20%">
					<?php
						$fn = $settings['path'].'specialty_templates/'.$sitename.'/'.$row['template_name'].'.spec';
						//echo $fn;
						...
						$sync_time_human = (isset($settings["message_pages_enabled"])) ? date("Y-m-d H:i:s",$file_info["date"]) : "no file";
		...
		<!--<td width="29%" valign="top">
			<table style="width:100%;float:left;" cellspacing="2" cellpadding="2" border="0" align="center" class="mainTable" id="multee_slugs_tbl">
				<thead>
				<tr>
					<th class="header" colspan="6"><?php echo $this->EE->lang->line('latest_submissions_title'); ?></th>
				</tr>
				</thead>
				<tbody>
				<tr>
					<td>
					<strong>[S] Title of Snippet Here</strong>
					<br />
					<em>Added 10 mins ago by cwcrawley</em>
					<br />
					<br />
					Information on what the snippet does with an explanation here (text only).
					<br />
					<a href=""><?php echo $this->EE->lang->line('opt_install'); ?></a> | <a href=""><?php echo $this->EE->lang->line('opt_view'); ?></a>
					</td>
				</tr>
				</tbody>
				<tfoot>
				<tr class="slug_nav">
					<td colspan="6" align="right"><?php echo $this->EE->lang->line('view_more_on'); ?><a href="">www.libraree.net</a></td>
				</tr>
				</tfoot>
			</table>
		</td>-->
