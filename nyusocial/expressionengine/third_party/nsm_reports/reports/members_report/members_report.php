...
class Members_report extends Nsm_report_base {
	 ...
	 * @access protected
	 */
	protected $title = 'Channels: Users Latest Visits';
	 ...
	 * @access protected
	 */
	protected $notes = 'List of users by Day of enrolment and Latest Visit';
	 ...
	 * @access protected
	 */
	protected $author = 'Urgent Content';
	 ...
	 * @access protected
	 */
	protected $docs_url = 'http://shanghai.nyu.edu';
